...
namespace Condiva.Api.Migrations
{
    ...
    [Migration("20260222212808_add_content_moderation")]
    partial class add_content_moderation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Condiva.Api.Common.Idempotency.Models.IdempotencyRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ActorUserId", "Method", "Path", "IdempotencyKey")
                        .IsUnique();
            ...
            modelBuilder.Entity("Condiva.Api.Features.Communities.Models.Community", b =>
                {
                    ...
                    b.Property<int>("ContentModerationMode")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Condiva.Api.Features.Communities.Models.CommunityBannedTerm", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("CommunityId", "NormalizedTerm")
                        .IsUnique();

                    b.ToTable("CommunityBannedTerms");
                });
            ...
            modelBuilder.Entity("Condiva.Api.Features.Requests.Models.Request", b =>
                {
                    ...
                    b.HasIndex("CommunityId", "Status", "NeededTo");

                    b.HasIndex("CommunityId", "Status", "CreatedAt", "Id")
                        .IsDescending(false, false, true, true);

                    b.HasIndex("CommunityId", "RequesterUserId", "Status", "CreatedAt", "Id")
            ...
            modelBuilder.Entity("Condiva.Api.Features.Communities.Models.CommunityBannedTerm", b =>
                {
                    b.HasOne("Condiva.Api.Features.Communities.Models.Community", "Community")
                        .WithMany("BannedTerms")
                        .HasForeignKey("CommunityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Condiva.Api.Common.Auth.Models.User", "CreatedByUser")
                        .WithMany()
